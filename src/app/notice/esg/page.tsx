...
export default function ESGPage() {
  ...
  const getPosts = () => {
    if (searchQuery.trim()) {
      return searchESGPosts(searchQuery, language as 'ko' | 'en')
    }

    if (activeCategory === 'all') {
      return getRecentESGPosts(50) // Get all recent posts
    }

    return getESGPostsByCategory(activeCategory)
  }

  const filteredPosts = getPosts()
  const recentPosts = getRecentESGPosts(3)

  // Categories for filter
  const categories = [
    { id: 'all', name: { ko: '전체', en: 'All' } },
    { id: 'environment', name: { ko: '환경', en: 'Environment' } },
    { id: 'social', name: { ko: '사회공헌', en: 'Social' } },
    { id: 'governance', name: { ko: '경영', en: 'Governance' } },
  ]
        ...
        <div className="echoit-container">
          ...
          <p className="text-gray-300 max-w-2xl">
            {language === 'ko'
              ...
              : 'Echo IT pursues sustainable management that considers the environment, society, and governance.'}
          </p>
        </div>
      </div>
            ...
            <div>
              ...
              <p className="text-gray-700 mb-6">
                {language === 'ko'
                  ...
                  : 'Echo IT pursues sustainable growth through ESG management that considers Environment, Social, and Governance factors. Our ESG strategy focuses on minimizing environmental impact using digital technology, creating social value, and building a transparent and responsible management system.'
                }
              </p>
