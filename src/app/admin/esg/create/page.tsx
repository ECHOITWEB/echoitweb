          ...
          <div className="space-y-6">
            <div>
              <label htmlFor="category" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                ESG 카테고리 <span className="text-red-500">*</span>
              </label>
              <select
                id="category"
                name="category"
              ...
              >
                ...
                <option value="governance">지배구조(G)</option>
              </select>
              {errors.category && (
        ...
        <div className="space-y-4">
          ...
          {activeTab === 'en' && (
            <ModernEditor
              ...
              label="내용 (영문)"
              placeholder="Enter the ESG content..."
